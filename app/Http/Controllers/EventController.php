...
class EventController extends Controller
{
    ...
    public function create(Request $request, $subdomain)
    {
        ...
        if ($role->default_tickets) {
            ...
            $event->remind_unpaid_tickets_every = $defaultTickets['remind_unpaid_tickets_every'] ?? 0;
            ...
            $event->remind_unpaid_tickets_every = 0;
    ...
    public function update(EventUpdateRequest $request, $subdomain, $hash)
    {
        ...
        if ($request->has('save_default_tickets')) {
            $defaultTickets = [
                ...
                'remind_unpaid_tickets_every' => $event->remind_unpaid_tickets_every,
