                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                        <div class="px-6 py-5">
                            ...
                            @if ($event->flyer_image_url)
                                <div class="mt-6">
                                    <h3 class="text-base font-medium text-gray-900 dark:text-gray-100 mb-3">{{ __('messages.flyer_image') }}</h3>
                                    <img src="{{ $event->flyer_image_url }}" alt="{{ __('messages.flyer_image') }}" class="rounded-lg shadow-sm" style="max-height: 400px; max-width: 100%;">
                                </div>
                            @endif
